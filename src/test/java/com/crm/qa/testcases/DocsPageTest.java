...
public class DocsPageTest extends TestBase {
	...
	public void validateCreateNewDocument(String docTitle, String docDescription, String docVersion, String docContact,
			String docClient, String docProspect, String docTask, String docCase, String docTags)
			throws InterruptedException, AWTException {

		homePage.clickOnNewDocumentLink();
		docsPage.createNewDocument(docTitle, docDescription, docVersion, docContact, docClient, docProspect, docTask,
				docCase, docTags);
